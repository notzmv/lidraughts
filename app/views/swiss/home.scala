        ...
        main(cls := "page-small box box-pad page swiss-home")(
          ...
          div(cls := "faq")(
            ...
            p(
              ...
              "Swiss tournaments were not designed for online draughts. They demand punctuality, dedication and patience from players.",
              br,
          ...
          div(cls := "faq")(
            ...
            p(
              ...
              "We don't plan to add more tournament systems to Lidraughts at the moment."
            )
          )
        )
      }
