...
val `waitingForPlayer` = new Translated("waitingForPlayer", Site)
...
val `microMatch` = new Translated("microMatch", Site)
val `microMatchChallenge` = new Translated("microMatchChallenge", Site)
val `microMatchExplanation` = new Translated("microMatchExplanation", Site)
val `microMatchRematchStarted` = new Translated("microMatchRematchStarted", Site)
val `microMatchRematchAwaiting` = new Translated("microMatchRematchAwaiting", Site)
val `microMatchGameX` = new Translated("microMatchGameX", Site)
...
val `promotion` = new Translated("promotion", Site)
val `variantEnding` = new Translated("variantEnding", Site)
val `important` = new Translated("important", Site)
val `yourQuestionMayHaveBeenAnswered` = new Translated("yourQuestionMayHaveBeenAnswered", Site)
val `inTheFAQ` = new Translated("inTheFAQ", Site)
val `toReportSomeoneForCheatingOrBadBehavior` = new Translated("toReportSomeoneForCheatingOrBadBehavior", Site)
val `useTheReportForm` = new Translated("useTheReportForm", Site)
val `toRequestSupport` = new Translated("toRequestSupport", Site)
val `tryTheContactPage` = new Translated("tryTheContactPage", Site)
val `thisTopicIsArchived` = new Translated("thisTopicIsArchived", Site)
val `joinTheTeamXToPost` = new Translated("joinTheTeamXToPost", Site)
val `teamNamedX` = new Translated("teamNamedX", Site)
val `youCannotPostYetPlaySomeGames` = new Translated("youCannotPostYetPlaySomeGames", Site)
val `subscribe` = new Translated("subscribe", Site)
val `unsubscribe` = new Translated("unsubscribe", Site)
...
val `importPdn` = new Translated("importPdn", Site)
...
val `drawOffersAfterX` = new Translated("drawOffersAfterX", Site)
val `drawOffersNotAllowed` = new Translated("drawOffersNotAllowed", Site)
val `draw` = new Translated("draw", Site)
val `ongoingGames` = new Translated("ongoingGames", Site)
val `currentGames` = new Translated("currentGames", Site)
val `gamesInTimeout` = new Translated("gamesInTimeout", Site)
val `yourTurnInX` = new Translated("yourTurnInX", Site)
val `gameNumberX` = new Translated("gameNumberX", Site)
...
val `youMustSignInToJoinIt` = new Translated("youMustSignInToJoinIt", Site)
val `newToLidraughts` = new Translated("newToLidraughts", Site)
...
val `gameByUsername` = new Translated("gameByUsername", Site)
val `gameByUrlOrId` = new Translated("gameByUrlOrId", Site)
val `games` = new Translated("games", Site)
val `userTv` = new Translated("userTv", Site)
...
val `changeUsername` = new Translated("changeUsername", Site)
val `changeUsernameAlreadyChanged` = new Translated("changeUsernameAlreadyChanged", Site)
val `changeUsernameNotSame` = new Translated("changeUsernameNotSame", Site)
val `changeUsernameDescription` = new Translated("changeUsernameDescription", Site)
...
val `arbiterDraw` = new Translated("arbiterDraw", Site)
val `arbiterResign` = new Translated("arbiterResign", Site)
...
val `startingIn` = new Translated("startingIn", Site)
val `startingSoon` = new Translated("startingSoon", Site)
...
val `finishesX` = new Translated("finishesX", Site)
...
val `variantTitleStandard` = new Translated("variantTitleStandard", Site)
val `variantTitleFrisian` = new Translated("variantTitleFrisian", Site)
val `variantTitleFrysk` = new Translated("variantTitleFrysk", Site)
val `variantTitleAntidraughts` = new Translated("variantTitleAntidraughts", Site)
val `variantTitleBreakthrough` = new Translated("variantTitleBreakthrough", Site)
val `variantTitleRussian` = new Translated("variantTitleRussian", Site)
val `variantTitleBrazilian` = new Translated("variantTitleBrazilian", Site)
val `customStartingPosition` = new Translated("customStartingPosition", Site)
...
val `gamesWillImpactThePlayersRating` = new Translated("gamesWillImpactThePlayersRating", Site)
...
val `freeOnlineDraughts` = new Translated("freeOnlineDraughts", Site)
val `spectators` = new Translated("spectators", Site)
val `exportGames` = new Translated("exportGames", Site)
val `exportSimulGames` = new Translated("exportSimulGames", Site)
val `ratingRange` = new Translated("ratingRange", Site)
val `giveMoreTime` = new Translated("giveMoreTime", Site)
val `thisPlayerUsesDraughtsComputerAssistance` = new Translated("thisPlayerUsesDraughtsComputerAssistance", Site)
...
val `myTournaments` = new Translated("myTournaments", Site)
val `createdTournaments` = new Translated("createdTournaments", Site)
val `recentlyPlayed` = new Translated("recentlyPlayed", Site)
val `bestResults` = new Translated("bestResults", Site)
...
val `backToSimul` = new Translated("backToSimul", Site)
...
val `xStartedStreaming` = new Translated("xStartedStreaming", Site)
val `averageElo` = new Translated("averageElo", Site)
val `averagePerformance` = new Translated("averagePerformance", Site)
val `averageScore` = new Translated("averageScore", Site)
val `teamPage` = new Translated("teamPage", Site)
val `viewAllTeams` = new Translated("viewAllTeams", Site)
val `pickYourTeam` = new Translated("pickYourTeam", Site)
val `whichTeamWillYouRepresent` = new Translated("whichTeamWillYouRepresent", Site)
val `youMustJoinOneOfTheseTeams` = new Translated("youMustJoinOneOfTheseTeams", Site)
...
val `pasteThePdnStringHere` = new Translated("pasteThePdnStringHere", Site)
val `fromPosition` = new Translated("fromPosition", Site)
val `continueFromHere` = new Translated("continueFromHere", Site)
val `toStudy` = new Translated("toStudy", Site)
val `pdnImportBy` = new Translated("pdnImportBy", Site)
val `importGame` = new Translated("importGame", Site)
val `importGameExplanation` = new Translated("importGameExplanation", Site)
val `orUploadAPdnFile` = new Translated("orUploadAPdnFile", Site)
val `thisIsADraughtsCaptcha` = new Translated("thisIsADraughtsCaptcha", Site)
...
val `notTheBestCapture` = new Translated("notTheBestCapture", Site)
val `colorPlaysCapture` = new Translated("colorPlaysCapture", Site)
...
val `makePrivateTournament` = new Translated("makePrivateTournament", Site)
...
val `save` = new Translated("save", Site)
...
val `noBerserkAllowed` = new Translated("noBerserkAllowed", Site)
val `editTournament` = new Translated("editTournament", Site)
val `tournamentDescription` = new Translated("tournamentDescription", Site)
val `tournamentDescriptionHelp` = new Translated("tournamentDescriptionHelp", Site)
val `cancelTheTournament` = new Translated("cancelTheTournament", Site)
...
val `watchLidraughtsTV` = new Translated("watchLidraughtsTV", Site)
val `previouslyOnLidraughtsTV` = new Translated("previouslyOnLidraughtsTV", Site)
val `collection` = new Translated("collection", Site)
val `customGamesCollection` = new Translated("customGamesCollection", Site)
val `editCollection` = new Translated("editCollection", Site)
val `copyCollectionUrl` = new Translated("copyCollectionUrl", Site)
val `reloadBoards` = new Translated("reloadBoards", Site)
val `reloadBoardsExplanation` = new Translated("reloadBoardsExplanation", Site)
val `reloadWithCurrentGameOfX` = new Translated("reloadWithCurrentGameOfX", Site)
val `addOngoingOrRecentGame` = new Translated("addOngoingOrRecentGame", Site)
val `addGameByUrlOrId` = new Translated("addGameByUrlOrId", Site)
val `removeGame` = new Translated("removeGame", Site)
...
val `standardFmjdRegulationsWithDrawingRules` = new Translated("standardFmjdRegulationsWithDrawingRules", Site)
val `exploreDraughtsVariants` = new Translated("exploreDraughtsVariants", Site)
val `rulesAndVariants` = new Translated("rulesAndVariants", Site)
...
val `hidden` = new Translated("hidden", Site)
...
val `switchGamesInSameOrder` = new Translated("switchGamesInSameOrder", Site)
val `autoSwitch` = new Translated("autoSwitch", Site)
val `sequentialSwitch` = new Translated("sequentialSwitch", Site)
val `puzzles` = new Translated("puzzles", Site)
val `variantPuzzles` = new Translated("variantPuzzles", Site)
...
val `showKingMoves` = new Translated("showKingMoves", Site)
...
val `cantOpenSimilarAccount` = new Translated("cantOpenSimilarAccount", Site)
val `closingIsDefinitive` = new Translated("closingIsDefinitive", Site)
...
val `newPasswordsDontMatch` = new Translated("newPasswordsDontMatch", Site)
...
val `coordinateSystem8x8` = new Translated("coordinateSystem8x8", Site)
val `fieldnumbers8x8` = new Translated("fieldnumbers8x8", Site)
val `algebraic8x8` = new Translated("algebraic8x8", Site)
val `moveListWhilePlaying` = new Translated("moveListWhilePlaying", Site)
val `notationGameResult` = new Translated("notationGameResult", Site)
val `draughtsClock` = new Translated("draughtsClock", Site)
val `clockInitialTime` = new Translated("clockInitialTime", Site)
val `clockIncrement` = new Translated("clockIncrement", Site)
val `onlyMembersOfTeam` = new Translated("onlyMembersOfTeam", Site)
val `noRestriction` = new Translated("noRestriction", Site)
...
val `howDoYouPlayMultiCaptures` = new Translated("howDoYouPlayMultiCaptures", Site)
val `stepByStep` = new Translated("stepByStep", Site)
val `allAtOnce` = new Translated("allAtOnce", Site)
...
val `victoryVsYInZ` = new Translated("victoryVsYInZ", Site)
...
val `start` = new Translated("start", Site)
...
val `youPlayTheWhitePieces` = new Translated("youPlayTheWhitePieces", Site)
val `youPlayTheBlackPieces` = new Translated("youPlayTheBlackPieces", Site)
val `itsYourTurn` = new Translated("itsYourTurn", Site)
...
val `connectedToLidraughts` = new Translated("connectedToLidraughts", Site)
...
val `studyMenu` = new Translated("studyMenu", Site)
val `practice` = new Translated("practice", Site)
...
val `sharePDN` = new Translated("sharePDN", Site)
...
val `blindfoldDraughts` = new Translated("blindfoldDraughts", Site)
...
val `displayBoardResizeHandle` = new Translated("displayBoardResizeHandle", Site)
val `onlyOnInitialPosition` = new Translated("onlyOnInitialPosition", Site)
...
val `xIsAFreeYLibreOpenSourceDraughtsServer` = new Translated("xIsAFreeYLibreOpenSourceDraughtsServer", Site)
...
val `simulShortName` = new Translated("simulShortName", Site)
val `simultaneousExhibitions` = new Translated("simultaneousExhibitions", Site)
val `simulDescription` = new Translated("simulDescription", Site)
val `simulDescriptionHelp` = new Translated("simulDescriptionHelp", Site)
val `yourPendingSimuls` = new Translated("yourPendingSimuls", Site)
val `host` = new Translated("host", Site)
val `hostColorX` = new Translated("hostColorX", Site)
val `arbiter` = new Translated("arbiter", Site)
val `createdSimuls` = new Translated("createdSimuls", Site)
val `hostANewSimul` = new Translated("hostANewSimul", Site)
val `followSimulHostTv` = new Translated("followSimulHostTv", Site)
val `shareSimulUrl` = new Translated("shareSimulUrl", Site)
val `candidatePlayers` = new Translated("candidatePlayers", Site)
val `allowedPlayers` = new Translated("allowedPlayers", Site)
val `acceptedPlayers` = new Translated("acceptedPlayers", Site)
val `acceptSomePlayers` = new Translated("acceptSomePlayers", Site)
val `acceptRandomCandidate` = new Translated("acceptRandomCandidate", Site)
val `youHaveBeenSelected` = new Translated("youHaveBeenSelected", Site)
val `xComplete` = new Translated("xComplete", Site)
val `ongoing` = new Translated("ongoing", Site)
val `winningPercentage` = new Translated("winningPercentage", Site)
val `targetPercentage` = new Translated("targetPercentage", Site)
val `toReachTarget` = new Translated("toReachTarget", Site)
val `relativeScoreRequired` = new Translated("relativeScoreRequired", Site)
val `targetWinningPercentage` = new Translated("targetWinningPercentage", Site)
val `currentWinningPercentage` = new Translated("currentWinningPercentage", Site)
...
val `simulHostColor` = new Translated("simulHostColor", Site)
val `simulChatRestrictionsHint` = new Translated("simulChatRestrictionsHint", Site)
val `simulTargetPercentageHint` = new Translated("simulTargetPercentageHint", Site)
val `simulParticipationLimited` = new Translated("simulParticipationLimited", Site)
val `chatAvailableFor` = new Translated("chatAvailableFor", Site)
val `chatAvailableForX` = new Translated("chatAvailableForX", Site)
val `everyone` = new Translated("everyone", Site)
val `spectatorsOnly` = new Translated("spectatorsOnly", Site)
val `participantsOnly` = new Translated("participantsOnly", Site)
val `atLeastOneVariant` = new Translated("atLeastOneVariant", Site)
val `invalidTargetPercentage` = new Translated("invalidTargetPercentage", Site)
val `lidraughtsTournaments` = new Translated("lidraughtsTournaments", Site)
...
val `averageCentipieceLoss` = new Translated("averageCentipieceLoss", Site)
...
val `monthlyPerfTypeRatingDistribution` = new Translated("monthlyPerfTypeRatingDistribution", Site)
...
val `networkLagBetweenYouAndLidraughts` = new Translated("networkLagBetweenYouAndLidraughts", Site)
val `timeToProcessAMoveOnLidraughtsServer` = new Translated("timeToProcessAMoveOnLidraughtsServer", Site)
...
val `inKidModeTheLidraughtsLogoGetsIconX` = new Translated("inKidModeTheLidraughtsLogoGetsIconX", Site)
...
val `speedUpYourAnalysis` = new Translated("speedUpYourAnalysis", Site)
val `enableFullCaptureAtXPreferences` = new Translated("enableFullCaptureAtXPreferences", Site)
val `playDraughtsEverywhere` = new Translated("playDraughtsEverywhere", Site)
val `asFreeAsLidraughts` = new Translated("asFreeAsLidraughts", Site)
val `builtForTheLoveOfDraughtsNotMoney` = new Translated("builtForTheLoveOfDraughtsNotMoney", Site)
...
val `correspondenceDraughts` = new Translated("correspondenceDraughts", Site)
...
val `xCreatesStudyY` = new Translated("xCreatesStudyY", Site)
...
val `directlySupportLidraughts` = new Translated("directlySupportLidraughts", Site)
val `playDraughtsInStyle` = new Translated("playDraughtsInStyle", Site)
val `draughtsBasics` = new Translated("draughtsBasics", Site)
val `coaches` = new Translated("coaches", Site)
val `invalidPdn` = new Translated("invalidPdn", Site)
val `invalidFen` = new Translated("invalidFen", Site)
val `invalidPosition` = new Translated("invalidPosition", Site)
val `tooManyKings` = new Translated("tooManyKings", Site)
...
val `error.pattern` = new Translated("error.pattern", Site)
val `error.eventName` = new Translated("error.eventName", Site)
val `mustNotContainLidraughts` = new Translated("mustNotContainLidraughts", Site)
...
val `back` = new Translated("back", Site)
...
val `helpPlayerInitialMove` = new Translated("helpPlayerInitialMove", Site)
val `introduceLesson` = new Translated("introduceLesson", Site)
val `putOpponentsFirstMove` = new Translated("putOpponentsFirstMove", Site)
val `explainOpponentMove` = new Translated("explainOpponentMove", Site)
val `reflectOnCorrectMove` = new Translated("reflectOnCorrectMove", Site)
val `addVariationsWrongMoves` = new Translated("addVariationsWrongMoves", Site)
val `explainWhyThisMoveIsWrong` = new Translated("explainWhyThisMoveIsWrong", Site)
val `orPromoteItToMainline` = new Translated("orPromoteItToMainline", Site)
val `anyOtherWrongMove` = new Translated("anyOtherWrongMove", Site)
val `explainWhyOtherMovesWrong` = new Translated("explainWhyOtherMovesWrong", Site)
val `optionalHint` = new Translated("optionalHint", Site)
val `giveThePlayerAHint` = new Translated("giveThePlayerAHint", Site)
val `whatWouldYouPlay` = new Translated("whatWouldYouPlay", Site)
val `lessonCompleted` = new Translated("lessonCompleted", Site)
val `nextChapter` = new Translated("nextChapter", Site)
val `playAgain` = new Translated("playAgain", Site)
val `analyse` = new Translated("analyse", Site)
val `preview` = new Translated("preview", Site)
...
val `pleasantDraughtsExperience` = new Translated("pleasantDraughtsExperience", Site)
...
val `lifetimeScore` = new Translated("lifetimeScore", Site)
val `currentMatchScore` = new Translated("currentMatchScore", Site)
val `winInXHalfMoves` = new Translated("winInXHalfMoves", Site)
val `drawInXHalfMoves` = new Translated("drawInXHalfMoves", Site)
val `nbPlayers` = new Translated("nbPlayers", Site)
val `nbOpponents` = new Translated("nbOpponents", Site)
val `nbGames` = new Translated("nbGames", Site)
val `nbGamesOngoing` = new Translated("nbGamesOngoing", Site)
...
val `nbVictories` = new Translated("nbVictories", Site)
...
val `nbPerfTypePlayersThisMonth` = new Translated("nbPerfTypePlayersThisMonth", Site)
...
val `nbMinutes` = new Translated("nbMinutes", Site)
val `nbTurns` = new Translated("nbTurns", Site)
...
object learn {
val `learnDraughts` = new Translated("learnDraughts", Learn)
...
val `draughtsPieces` = new Translated("draughtsPieces", Learn)
val `theMen` = new Translated("theMen", Learn)
...
val `youKnowHowToPlayDraughts` = new Translated("youKnowHowToPlayDraughts", Learn)
val `register` = new Translated("register", Learn)
val `getAFreeLidraughtsAccount` = new Translated("getAFreeLidraughtsAccount", Learn)
val `practice` = new Translated("practice", Learn)
val `makesYourDraughtsPerfect` = new Translated("makesYourDraughtsPerfect", Learn)
val `learnCommonDraughtsPositions` = new Translated("learnCommonDraughtsPositions", Learn)
val `signUpToSaveYourProgress` = new Translated("signUpToSaveYourProgress", Learn)
val `goToNextExercise` = new Translated("goToNextExercise", Learn)
val `loadNextExerciseImmediately` = new Translated("loadNextExerciseImmediately", Learn)
val `practiceList` = new Translated("practiceList", Learn)
val `backToPracticeMenu` = new Translated("backToPracticeMenu", Learn)
val `exerciseYourTacticalSkills` = new Translated("exerciseYourTacticalSkills", Learn)
val `videos` = new Translated("videos", Learn)
val `watchInstructiveDraughtsVideos` = new Translated("watchInstructiveDraughtsVideos", Learn)
...
val `success` = new Translated("success", Learn)
...
val `clickToRetry` = new Translated("clickToRetry", Learn)
val `winTheGame` = new Translated("winTheGame", Learn)
val `winTheGameInX` = new Translated("winTheGameInX", Learn)
val `holdTheDrawForX` = new Translated("holdTheDrawForX", Learn)
val `equalizeInX` = new Translated("equalizeInX", Learn)
val `defendForX` = new Translated("defendForX", Learn)
val `getAWinningPositionInX` = new Translated("getAWinningPositionInX", Learn)
}
...
val `solvedNbVariantPuzzles` = new Translated("solvedNbVariantPuzzles", Activity)
...
val `knowingTheDraughtsBoard` = new Translated("knowingTheDraughtsBoard", Coordinates)
val `mostDraughtsCourses` = new Translated("mostDraughtsCourses", Coordinates)
val `talkToYourDraughtsFriends` = new Translated("talkToYourDraughtsFriends", Coordinates)
...
val `hot` = new Translated("hot", Study)
val `dateAddedNewest` = new Translated("dateAddedNewest", Study)
val `dateAddedOldest` = new Translated("dateAddedOldest", Study)
val `recentlyUpdated` = new Translated("recentlyUpdated", Study)
val `mostPopular` = new Translated("mostPopular", Study)
...
val `pleaseOnlyInvitePeopleYouKnow` = new Translated("pleaseOnlyInvitePeopleYouKnow", Study)
val `searchByUsername` = new Translated("searchByUsername", Study)
val `spectator` = new Translated("spectator", Study)
val `contributor` = new Translated("contributor", Study)
val `kick` = new Translated("kick", Study)
val `leaveTheStudy` = new Translated("leaveTheStudy", Study)
val `youAreNowAContributor` = new Translated("youAreNowAContributor", Study)
val `youAreNowASpectator` = new Translated("youAreNowASpectator", Study)
val `pdnTags` = new Translated("pdnTags", Study)
val `like` = new Translated("like", Study)
val `newTag` = new Translated("newTag", Study)
val `commentThisPosition` = new Translated("commentThisPosition", Study)
val `commentThisMove` = new Translated("commentThisMove", Study)
val `annotateWithGlyphs` = new Translated("annotateWithGlyphs", Study)
val `theChapterIsTooShortToBeAnalysed` = new Translated("theChapterIsTooShortToBeAnalysed", Study)
val `onlyContributorsCanRequestAnalysis` = new Translated("onlyContributorsCanRequestAnalysis", Study)
val `getAFullComputerAnalysis` = new Translated("getAFullComputerAnalysis", Study)
val `makeSureTheChapterIsComplete` = new Translated("makeSureTheChapterIsComplete", Study)
...
val `studyPdn` = new Translated("studyPdn", Study)
val `chapterPdn` = new Translated("chapterPdn", Study)
...
val `startAtInitialPosition` = new Translated("startAtInitialPosition", Study)
...
val `onlyPublicStudiesCanBeEmbedded` = new Translated("onlyPublicStudiesCanBeEmbedded", Study)
...
val `editChapter` = new Translated("editChapter", Study)
val `newChapter` = new Translated("newChapter", Study)
val `orientation` = new Translated("orientation", Study)
val `analysisMode` = new Translated("analysisMode", Study)
val `pinnedChapterComment` = new Translated("pinnedChapterComment", Study)
val `saveChapter` = new Translated("saveChapter", Study)
val `clearAnnotations` = new Translated("clearAnnotations", Study)
val `deleteChapter` = new Translated("deleteChapter", Study)
val `deleteThisChapter` = new Translated("deleteThisChapter", Study)
val `clearAllCommentsInThisChapter` = new Translated("clearAllCommentsInThisChapter", Study)
val `rightUnderTheBoard` = new Translated("rightUnderTheBoard", Study)
val `noPinnedComment` = new Translated("noPinnedComment", Study)
val `normalAnalysis` = new Translated("normalAnalysis", Study)
val `hideNextMoves` = new Translated("hideNextMoves", Study)
val `interactiveLesson` = new Translated("interactiveLesson", Study)
val `chapterX` = new Translated("chapterX", Study)
val `empty` = new Translated("empty", Study)
val `startFromInitialPosition` = new Translated("startFromInitialPosition", Study)
val `editor` = new Translated("editor", Study)
val `startFromCustomPosition` = new Translated("startFromCustomPosition", Study)
val `loadAGameByUrl` = new Translated("loadAGameByUrl", Study)
val `loadAPositionFromFen` = new Translated("loadAPositionFromFen", Study)
val `loadAGameFromPdn` = new Translated("loadAGameFromPdn", Study)
val `automatic` = new Translated("automatic", Study)
val `urlOfTheGame` = new Translated("urlOfTheGame", Study)
val `loadAGameFromXOrY` = new Translated("loadAGameFromXOrY", Study)
val `createChapter` = new Translated("createChapter", Study)
val `configureLiveBroadcast` = new Translated("configureLiveBroadcast", Study)
val `createStudy` = new Translated("createStudy", Study)
val `editStudy` = new Translated("editStudy", Study)
val `visibility` = new Translated("visibility", Study)
val `public` = new Translated("public", Study)
val `unlisted` = new Translated("unlisted", Study)
val `inviteOnly` = new Translated("inviteOnly", Study)
val `allowCloning` = new Translated("allowCloning", Study)
val `nobody` = new Translated("nobody", Study)
val `onlyMe` = new Translated("onlyMe", Study)
val `contributors` = new Translated("contributors", Study)
val `members` = new Translated("members", Study)
val `everyone` = new Translated("everyone", Study)
val `enableSync` = new Translated("enableSync", Study)
val `yesKeepEveryoneOnTheSamePosition` = new Translated("yesKeepEveryoneOnTheSamePosition", Study)
val `noLetPeopleBrowseFreely` = new Translated("noLetPeopleBrowseFreely", Study)
val `pinnedStudyComment` = new Translated("pinnedStudyComment", Study)
val `start` = new Translated("start", Study)
val `save` = new Translated("save", Study)
val `clearChat` = new Translated("clearChat", Study)
val `deleteTheStudyChatHistory` = new Translated("deleteTheStudyChatHistory", Study)
val `deleteStudy` = new Translated("deleteStudy", Study)
val `deleteTheEntireStudy` = new Translated("deleteTheEntireStudy", Study)
val `whereDoYouWantToStudyThat` = new Translated("whereDoYouWantToStudyThat", Study)
...
val `openTwoFactorApp` = new Translated("openTwoFactorApp", Tfa)
}
...
val `deleteTeamWarning` = new Translated("deleteTeamWarning", Team)
...
val `swissTournament` = new Translated("swissTournament", Team)
val `swissTournamentOverview` = new Translated("swissTournamentOverview", Team)
val `subscribeToTeamMessages` = new Translated("subscribeToTeamMessages", Team)
val `messageAllMembers` = new Translated("messageAllMembers", Team)
val `messageAllMembersOverview` = new Translated("messageAllMembersOverview", Team)
val `messageAllMembersLongDescription` = new Translated("messageAllMembersLongDescription", Team)
val `teamsIlead` = new Translated("teamsIlead", Team)
val `youMayWantToLinkOneOfTheseTournaments` = new Translated("youMayWantToLinkOneOfTheseTournaments", Team)
val `usersWhoCanManageThisTeam` = new Translated("usersWhoCanManageThisTeam", Team)
val `leadersChat` = new Translated("leadersChat", Team)
val `enableMembersChat` = new Translated("enableMembersChat", Team)
val `nbMembers` = new Translated("nbMembers", Team)
val `teamLeaders` = new Translated("teamLeaders", Team)
...
val `absent` = new Translated("absent", Swiss)
val `absences` = new Translated("absences", Swiss)
val `late` = new Translated("late", Swiss)
val `tieBreak` = new Translated("tieBreak", Swiss)
...
val `sourceUrlOrGameIds` = new Translated("sourceUrlOrGameIds", Broadcast)
val `sourceUrlHelp` = new Translated("sourceUrlHelp", Broadcast)
val `gameIdsHelp` = new Translated("gameIdsHelp", Broadcast)
...
object streamer {
val `lidraughtsStreamers` = new Translated("lidraughtsStreamers", Streamer)
val `lidraughtsStreamer` = new Translated("lidraughtsStreamer", Streamer)
...
val `freeDraughts` = new Translated("freeDraughts", Patron)
...
val `weAreVolunteers` = new Translated("weAreVolunteers", Patron)
...
val `donatingPubliclyAs` = new Translated("donatingPubliclyAs", Patron)
...
val `serversAndExpenses` = new Translated("serversAndExpenses", Patron)
...
val `paypalRenew` = new Translated("paypalRenew", Patron)
