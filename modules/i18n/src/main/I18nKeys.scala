...
val `notACapture` = new Translated("notACapture", Site)
...
val `pdnPieceNotation` = new Translated("pdnPieceNotation", Site)
val `draughtsPieceSymbol` = new Translated("draughtsPieceSymbol", Site)
val `pdnLetter` = new Translated("pdnLetter", Site)
...
val `matches` = new Translated("matches", Site)
val `createdMatches` = new Translated("createdMatches", Site)
val `createANewMatch` = new Translated("createANewMatch", Site)
val `aboutMatch` = new Translated("aboutMatch", Site)
val `noMatchFound` = new Translated("noMatchFound", Site)
val `noMatchExplanation` = new Translated("noMatchExplanation", Site)
val `returnToMatchHomepage` = new Translated("returnToMatchHomepage", Site)
...
val `xCreatesY` = new Translated("xCreatesY", Site)
